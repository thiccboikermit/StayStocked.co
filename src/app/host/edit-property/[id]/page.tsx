...
export default function EditPropertyPage() {
  ...
  useEffect(() => {
    ...
    if (!currentUser || !isHost(currentUser)) {
      router.push(`/auth/signin?callbackUrl=/host/edit-property/${propertyId}`);
      return;
    }
    setUser(currentUser);
    ...
    if (!propertyData || propertyData.hostId !== currentUser.id) {
      router.push('/host');
      return;
    }
    ...
    setFormData({
      ...
      kitchenAmenities: propertyData.kitchenAmenities || [],
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 font-display">Edit Property</h2>
          <p className="text-gray-600 mt-1">Update the details of your vacation rental property</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="mt-2 text-sm text-gray-500">
                Import your Airbnb calendar to automatically validate guest booking dates.
              </p>
            </div>
